...
CREATE TABLE `users_characters` (
  ...
  KEY `fk_users_characters_users_idx` (`character_user_id`),
  CONSTRAINT `fk_users_characters_users` FOREIGN KEY (`character_user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `users_characters` WRITE;
